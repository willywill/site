...
const SkillsSection = () => (
  <Flex as="section" id="/skills" column>
    <Flex column py={6} background={SECONDARY_COLOR} style={{ overflow: 'hidden', position: 'relative' }}>
      ...
      <Flex width={1} my={4} px={2} justify="center" flexDirection={mediaQueryLessThan('column', 'tablet', 'row')}>
        <Flex justify="center" style={{ overflow: 'hidden' }} flexDirection={mediaQueryLessThan('row', 'tablet', 'column')}>
