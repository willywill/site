...
const PhotographySection = () => (
	<Flex as="section" id="/photography" column>
		<Flex mb={1} column style={{ position: "relative", overflow: "hidden" }}>
			<CameraVisualization
				src="/visualizations/mirrorless.webp"
				alt="Mirrorless Outline Drawing"
			/>
			<Box width={1} mt={6}>
			...
			<Flex width={1} mr={6} ml={4} mt={5} mb={8} align="center" column>
				...
				>
					<Box mb={5} width={mediaQueryLessThan(0.35, "tablet", 1)}>
						<ImageWrapper>
							<Flex
								ml={mediaQueryLessThan("0px", "tablet", "15px")}
								justifyContent={mediaQueryLessThan(
									"flex-end",
									"tablet",
									"center",
								)}
					...
					<Box
						width={mediaQuery(0.15, { mobileSmall: "0px", desktopSmall: 0.05 })}
					/>
					<Box mb={5} width={mediaQueryLessThan(0.35, "tablet", 1)}>
						<ImageWrapper>
							<Flex
								mr={mediaQueryLessThan("0px", "tablet", "35px")}
								mt={mediaQueryLessThan(7, "tablet", "0px")}
								justifyContent={mediaQueryLessThan(
									"flex-start",
									"tablet",
									"center",
				...
				>
					...
					<Box mt={6} width={mediaQueryLessThan(0.35, "tablet", 1)}>
						<ImageWrapper>
							<Flex
								mr={mediaQueryLessThan("0px", "tablet", "35px")}
								mt={mediaQueryLessThan(5, "tablet", "0px")}
								justifyContent={mediaQueryLessThan(
									"flex-start",
									"tablet",
									"center",
					...
					<LensVisualization
						src="/visualizations/lens.png"
						alt="Camera Lens Exploded View"
					/>
				</Flex>
			</Flex>
		</Flex>
