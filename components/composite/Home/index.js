...
import { mediaQuery, PRIMARY_COLOR, SUBTITLE_COLOR } from '../../../utils/theme';
import { Flex, Box, Text, Heading } from '../../ui';

const HomeSection = () => (
  <Flex width={1}>
    <Box width={mediaQuery(0.6, { tablet: 1, desktopSmall: 1 })}>
...
working on full-stack web development, real-time computer graphics and photography.`}
    ...
    <Box width={mediaQuery(0.4, { tablet: '0px', desktopSmall: '0px' })} />
  </Flex>
);
